...
This project is indexed by GitNexus as **manga-image-translator** (9647 symbols, 17235 relationships, 292 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
