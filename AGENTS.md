...
This project is indexed by GitNexus as **manga-image-translator** (9435 symbols, 17144 relationships, 290 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
