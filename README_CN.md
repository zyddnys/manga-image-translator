...
1. Python>=3.8
2. clone这个repo
3. [下载](https://github.com/zyddnys/manga-image-translator/releases/tag/beta-0.2.1) `ocr.ckpt`、`detect.ckpt`、`comictextdetector.pt`和`inpainting.ckpt`，放到这个repo的根目录下
