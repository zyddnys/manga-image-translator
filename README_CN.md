...
- [漫画/图片翻译器 (中文说明)](#漫画图片翻译器-中文说明)
  - [最后更新时间：2025年5月10日](#最后更新时间2025年5月10日)
  - [📂 目录](#-目录)
  - [效果图](#效果图)
  - [在线版](#在线版)
  - [安装](#安装)
  ...
  - [使用](#使用)
    ...
    - [API模式](#api模式)
      - [API 文档](#api-文档)
        - [通过浏览器脚本使用API](#通过浏览器脚本使用api)
    - [config-help 模式](#config-help-模式)
  - [参数及配置](#参数及配置)
    - [推荐参数](#推荐参数)
      - [提升翻译质量的技巧](#提升翻译质量的技巧)
    - [命令行参数](#命令行参数)
      ...
      - [附加参数](#附加参数)
        ...
        - [API模式参数](#api模式参数)
        - [网页模式参数（缺少一些基本参数，仍有待添加）](#网页模式参数缺少一些基本参数仍有待添加)
    - [配置文件](#配置文件)
      - [渲染参数](#渲染参数)
      - [超分参数](#超分参数)
      - [翻译参数](#翻译参数)
...
##### 通过浏览器脚本使用API  
[演示脚本](demo/api/browserscreen-translate.js)使用`127.0.0.1:8000`提供的`/translate/image`接口进行用户页面截图->翻译->展示  
您需要根据实际修改：`@match` `@connect` `API_HOST` `FIXED_CONFIG`字段
