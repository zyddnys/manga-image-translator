...
OPENAI_GLOSSARY_PATH = os.getenv('OPENAI_GLOSSARY_PATH', os.path.join(current_directory, '../../dict/mit_glossory.txt')) # OpenAI术语表路径
...
SAKURA_DICT_PATH = os.getenv('SAKURA_DICT_PATH', os.path.join(current_directory, '../../dict/sakura_dict.txt')) #SAKURA 术语表路径
