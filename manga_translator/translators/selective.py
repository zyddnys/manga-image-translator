...
class SelectiveOfflineTranslator(OfflineTranslator):
    ...
    async def translate(self, from_lang: str, to_lang: str, queries: List[str], use_mtpe: bool, model_name: str = None) -> List[str]:
        if from_lang == 'auto':
        ...
        return await self._real_translator.translate(from_lang, to_lang, queries, use_mtpe, model_name=model_name)
